...
/*
  ...
  More specifically, it is the config layout for the filter_reader aspect of the DMA module
*/

typedef struct packed {
  dma_config_filter_reader_loop loop_increment; // address increment on each iteration for each level
  dma_config_filter_reader_loop loop_count;     // number of iterations for each level of loop nesting
